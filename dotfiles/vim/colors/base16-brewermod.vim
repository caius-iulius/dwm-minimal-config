...
if has("nvim")
  ...
  let g:terminal_color_11 = "#ffae42"
...
hi clear
syntax reset
let g:colors_name = "base16-brewermod"
...
call <sid>hi("MatchParen",    s:gui0A, s:gui00, s:cterm0A,  s:cterm00, "bold", "")
...
call <sid>hi("LineNr",        s:gui0A, s:gui00, s:cterm0A, s:cterm00, "", "")
call <sid>hi("SignColumn",    s:gui0A, s:gui00, s:cterm0A, s:cterm00, "", "")
